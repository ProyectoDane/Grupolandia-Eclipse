...
import com.infinixsoft.TexturePacker.Level3;
...
public class NivelDificilScene {
	...
	private static int placedItems = 0, totalItems = 14;
	private static String backgroundPath = "gfx/bgniveles.png";
	private static String texturePackerName = "level3.xml";
	...
	public static void load(GameActivity myActivity) {
		...
		// getinfobutton
		scene = context.getInfoButtonSprite(scene, SceneType.NIVELDIFICIL);

		Level3 texturePackerInterface = new Level3() {
		};
		...
		TextureRegion item11TextureRegion = mSpritesheetTexturePackTextureRegionLibrary.get(texturePackerInterface.ITEM11_ID);
		TextureRegion item12TextureRegion = mSpritesheetTexturePackTextureRegionLibrary.get(texturePackerInterface.ITEM12_ID);
		TextureRegion item13TextureRegion = mSpritesheetTexturePackTextureRegionLibrary.get(texturePackerInterface.ITEM13_ID);
		TextureRegion item14TextureRegion = mSpritesheetTexturePackTextureRegionLibrary.get(texturePackerInterface.ITEM14_ID);

		// Add items to scene
		// fila inferior
		addItem(item8TextureRegion, 262, 271, 1);
		addItem(item9TextureRegion, 342, 268, 1);
		addItem(item10TextureRegion, 405, 268, 3);
		addItem(item11TextureRegion, 468, 268, 3);
		addItem(item12TextureRegion, 499, 269, 1);
		addItem(item13TextureRegion, 582, 267, 2);
		addItem(item14TextureRegion, 634, 269, 3);
		// fila superior
		addItem(item1TextureRegion, 304, 72, 3);
		addItem(item2TextureRegion, 312, 76, 2);
		addItem(item3TextureRegion, 405, 73, 3);
		addItem(item4TextureRegion, 452, 73, 1);
		addItem(item5TextureRegion, 489, 75, 1);
		addItem(item6TextureRegion, 567, 73, 2);
		addItem(item7TextureRegion, 618, 75, 3);
